...
{Tang \MakeLowercase{\textit{et al.}}: AutoShotV2 for Short-Video Shot Boundary Detection}
...
\begin{IEEEkeywords}
Shot boundary detection, short video, AutoShot, TransNetV2, Focal Loss, temperature scaling, Gaussian smoothing, video understanding.
\end{IEEEkeywords}
...
\bibitem{baraldi2015rai}
L. Baraldi, C. Grana, and R. Cucchiara, ``Shot and scene detection via hierarchical clustering for re-using broadcast video,'' in \emph{Computer Analysis of Images and Patterns}, 2015, pp. 801--811.
...
\bibitem{hassanien2017largescale}
...
I. Loshchilov and F. Hutter, ``SGDR: Stochastic gradient descent with warm restarts,'' in \emph{Proc. International Conference on Learning Representations}, 2017.

\bibitem{vietnamnet2023shortform}
V. Anh, ``Short-form video trend harming youth,'' \emph{VietnamNet Global}, May 2023.
...
R. M{\"u}ller, S. Kornblith, and G. E. Hinton, ``When does label smoothing help?'' in \emph{Proc. Advances in Neural Information Processing Systems}, 2019, pp. 4694--4703.
...
H. Liu, K. Simonyan, and Y. Yiming, ``DARTS: Differentiable architecture search,'' in \emph{Proc. International Conference on Learning Representations}, 2019.
