...
complementary questions. Video-level bootstrap intervals
(Table~\ref{tab:confidence}) quantify how much the test score depends on
which videos were sampled, and remain the dominant term: their widths are an
order of magnitude larger than the seed-induced standard deviations of
Table~\ref{tab:seed_robustness}. Training-seed variability, the usual
...
(0.8991), but the dominant loss is aggregate precision (0.6498): open-world
content produces false-positive peaks that survive smoothing. A frozen
