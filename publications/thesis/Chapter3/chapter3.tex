...
\begin{quotation}
    \noindent
    \small\textit{
        Chương này trình bày phương pháp được sử dụng trong khóa luận. Trọng tâm là kế thừa AutoShot, giữ lại mạng xương sống đã được NAS tối ưu, sau đó cải tiến tầng phân loại, hàm mất mát, nhãn giám sát và các bước hậu xử lý xác suất để hình thành AutoShotV2. Các phần nền tảng về NAS và TransNetV2 được giữ lại ở mức cần thiết nhằm làm rõ cơ sở kế thừa trước khi đi vào phương pháp cải tiến; thiết lập thực nghiệm được trình bày ở Chương~\ref{ch:bo_du_lieu_va_thuc_nghiem} và kết quả được phân tích ở Chương~\ref{ch:ket_qua_thuc_nghiem}.
    }
\end{quotation}
...
% =====================================================================
\section*{PHẦN A. NỀN TẢNG KẾ THỪA}
\phantomsection
\addcontentsline{toc}{section}{PHẦN A. NỀN TẢNG KẾ THỪA}
\vspace{0.5em}
\noindent
Phần này hệ thống hóa hai khối kiến thức nền tảng được khóa luận kế thừa: \textbf{(i)} các nguyên lý và kỹ thuật của Neural Architecture Search (Mục~\ref{sec:nas}) -- là công cụ trung tâm mà AutoShot vận dụng để tìm ra kiến trúc tối ưu cho SBD, và \textbf{(ii)} mô hình TransNetV2 (Mục~\ref{sec:transnetv2}) -- là mô hình cơ sở trực tiếp mà các đóng góp ở Phần B sẽ so sánh và cải tiến.
\vspace{1em}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[>=Latex,font=\footnotesize]
        \node[draw, rounded corners, fill=blue!12, text width=3.6cm, minimum height=1.25cm, align=center] (space) at (0,0) {Không gian tìm kiếm\\(không gian tìm kiếm)\\$\mathcal{A}$};
        ...
        \node[draw, rounded corners, fill=purple!12, text width=3.0cm, minimum height=1.25cm, align=center] (output) at (9.2,-1.4) {Kiến trúc tối ưu\\$a^*$};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[>=Latex,font=\footnotesize]
        ...
        \node[draw, rounded corners, fill=gray!10, text width=1.7cm, minimum height=0.85cm, align=center] (s1) at (3.1,1.8) {Spatial\\$1\times k\times k$};
        \node[draw, rounded corners, fill=gray!10, text width=1.7cm, minimum height=0.85cm, align=center] (s2) at (3.1,0.6) {Spatial\\$1\times k\times k$};
        \node[draw, rounded corners, fill=gray!10, text width=1.7cm, minimum height=0.85cm, align=center] (s3) at (3.1,-0.6) {Spatial\\$1\times k\times k$};
        \node[draw, rounded corners, fill=gray!10, text width=1.7cm, minimum height=0.85cm, align=center] (s4) at (3.1,-1.8) {Spatial\\$1\times k\times k$};

        \node[draw, rounded corners, fill=green!12, text width=2.2cm, minimum height=0.9cm, align=center] (t1) at (6.3,1.8) {Temporal\\$k\times1\times1$\\$d=1$};
        \node[draw, rounded corners, fill=green!12, text width=2.2cm, minimum height=0.9cm, align=center] (t2) at (6.3,0.6) {Temporal\\$k\times1\times1$\\$d=2$};
        \node[draw, rounded corners, fill=green!12, text width=2.2cm, minimum height=0.9cm, align=center] (t3) at (6.3,-0.6) {Temporal\\$k\times1\times1$\\$d=4$};
        \node[draw, rounded corners, fill=green!12, text width=2.2cm, minimum height=0.9cm, align=center] (t4) at (6.3,-1.8) {Temporal\\$k\times1\times1$\\$d=8$};

        \node[draw, rounded corners, fill=orange!18, text width=1.9cm, minimum height=1.0cm, align=center] (concat) at (9.3,0) {Concat\\theo kênh};
        \node[draw, rounded corners, fill=purple!12, text width=2.0cm, minimum height=1.0cm, align=center] (bn) at (12.0,0) {BatchNorm\\+ ReLU};
        \node[draw, rounded corners, fill=blue!10, text width=1.9cm, minimum height=1.0cm, align=center] (out) at (14.6,0) {Output\\$Y_t$};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[>=Latex,font=\scriptsize]
        \tikzset{
            ...
            data/.style={draw, rounded corners, fill=blue!10, minimum width=3.2cm, minimum height=0.72cm, align=center},
            spatial/.style={draw, rounded corners, fill=green!12, minimum width=3.2cm, minimum height=0.72cm, align=center},
            temporal/.style={draw, rounded corners, fill=orange!18, minimum width=3.2cm, minimum height=0.72cm, align=center},
            merge/.style={draw, rounded corners, fill=purple!12, minimum width=3.2cm, minimum height=0.72cm, align=center}
        }

        % DDCNNV2
        \begin{scope}[xshift=0cm]
            \node[titlebox] (t1) at (0,3.1) {DDCNNV2};
            \node[data] (i1) at (0,2.1) {Input};
            \node[spatial] (s1) at (0,1.1) {4 nhánh spatial riêng biệt};
            \node[temporal] (p1) at (0,0.1) {4 nhánh temporal giãn nở};
            \node[merge] (m1) at (0,-0.9) {Concat};
            \draw[->, thick] (i1) -- (s1);
            \draw[->, thick] (s1) -- (p1);
            \draw[->, thick] (p1) -- (m1);
        \end{scope}
        ...
        \begin{scope}[xshift=5.0cm]
            \node[titlebox] (t2) at (0,3.1) {DDCNNV2A};
            \node[data] (i2) at (0,2.1) {Input};
            \node[spatial] (s2) at (0,1.1) {Shared spatial conv};
            \node[temporal] (p2) at (0,0.1) {4 nhánh temporal giãn nở};
            \node[merge] (m2) at (0,-0.9) {Concat};
            \draw[->, thick] (i2) -- (s2);
            \draw[->, thick] (s2) -- (p2);
            \draw[->, thick] (p2) -- (m2);
        \end{scope}
        ...
        \begin{scope}[xshift=10.0cm]
            \node[titlebox] (t3) at (0,3.1) {DDCNNV2B};
            \node[data] (i3) at (0,2.1) {Input};
            \node[spatial] (s3) at (-1.1,0.9) {Spatial};
            \node[temporal] (p3) at (1.1,0.9) {Temporal};
            \node[merge] (m3) at (0,-0.2) {Add};
            \draw[->, thick] (i3) -- (s3);
            \draw[->, thick] (i3) -- (p3);
            \draw[->, thick] (s3) -- (m3);
            \draw[->, thick] (p3) -- (m3);
        ...
        \begin{scope}[xshift=15.0cm]
            \node[titlebox] (t4) at (0,3.1) {DDCNNV2C};
            \node[data] (i4) at (0,2.1) {Input};
            \node[spatial] (s4) at (0,1.1) {Shared spatial conv};
            \node[temporal] (p4) at (0,0.1) {Temporal giãn nở};
            \node[merge] (m4) at (0,-0.9) {Add};
            \draw[->, thick] (i4) -- (s4);
            \draw[->, thick] (s4) -- (p4);
            \draw[->, thick] (p4) -- (m4);
...
\subsection{Kiến trúc ClassificationHead}
\label{subsec:v2_head}

Tương tự AutoShot, AutoShotV2 thiết kế một \texttt{ClassificationHead} hai nhánh song song đặt sau lớp trích xuất đặc trưng 4864-D:
\begin{enumerate}
    ...
    \item \textbf{cls\_layer1}: Linear(1024 $\to$ 1) --- nhánh chính với \textbf{nhãn one-hot}, học định vị ranh giới chính xác.
    \item \textbf{cls\_layer2}: Linear(1024 $\to$ 1) --- nhánh phụ với \textbf{nhãn many-hot}, học ngữ cảnh vùng quanh ranh giới.
\end{enumerate}
...
\end{tikzpicture}
\caption[Kiến trúc ClassificationHead trong AutoShotV2]{Kiến trúc ClassificationHead trong AutoShotV2. Head nhận đặc trưng 4864-D từ mạng xương sống (đóng băng) và sinh hai đầu ra song song: nhánh one-hot định vị ranh giới chính xác và nhánh many-hot học ngữ cảnh vùng biên.}
...
AutoShotV2 bổ sung một nhánh giám sát phụ với \textbf{nhãn many-hot}~\cite{Muller2019LabelSmoothing}: tất cả các khung trong phạm vi $\pm1$ frame quanh ranh giới đều được coi là dương:
\begin{equation}
    y_{\text{many-hot}}[t] =
    \begin{cases}
...
\node[anchor=east] at (-0.25, 0.7) {One-hot:};
\foreach \i/\c/\v in {
...
\node[anchor=east] at (-0.25, -0.7) {Many-hot:};
\foreach \i/\c/\v in {
  0/white/0, 1/white/0,
...
\end{tikzpicture}
\caption[Minh họa nhãn one-hot và many-hot]{Minh họa nhãn one-hot và many-hot. Nhãn one-hot chỉ gán 1 tại đúng khung ranh giới $t$; nhãn many-hot mở rộng thêm $t\pm1$, cung cấp tín hiệu gradient dày đặc hơn quanh vùng ranh giới.}
